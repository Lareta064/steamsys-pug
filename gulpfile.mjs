...
//
// gulp-webp настройки:
//   quality: 72 — на 3 пункта ниже дефолта (75). Визуально практически
//                 неотличимо от оригинала на фото/скриншотах. На гладких
//                 градиентах при пристальном сравнении можно заметить
//                 лёгкий шум. Если PageSpeed требует агрессивнее — можно
//                 опуститься до 70 (артефакты становятся видны на градиентах).
//   method: 6  — самый медленный, но лучший алгоритм сжатия (default: 4).
//                Добавляет пару секунд к сборке, ~3-5% экономии на файл.
//                На качество не влияет — только на время кодирования.
