...
- меню навигации в футере и отдельную колонку с ссылками навигации можно увидеть на скринах в папке temps/.ss-footer-nav.png, temps/.ss-footer-nav-mob.png, temps/.ss-footer-nav__item.png
- на больших экранах - это статичная колонка с заголовоком и ссылками, а на моб версии переходит в компонент типа акордеон. Как вариант, можно конкретно в этом компоненте попробовать реализовать без скрипта через input type="checkbox" Либо можно сразу создать компонент аккордеон и прописать ему скрипт. Как лучше?
- стили компонентов в одной колонке:
 Заголовок: как киккер цвета accent3, отступ снизу 10 пикс
 Ссылки: {
...
color: var(--white);
 ...
 между ссылками отступ 10 пикс

 на  моб версии, когда киккер работает как кликабельный button, имеет мин-высоту в 46 пикс и при открытом аккоредеоне сверху и снизу блок выделен бордерами цвета accent3, обрати на это внимание на скрине temps/ss-footer-nav-mob.png